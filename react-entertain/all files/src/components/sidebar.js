        ...
        <div className='logos mt-2 '>Myamuse</div>
                ...
                <div class="slimscroll-menu" id="left-side-menu-container">
                   ...
                   <div><Link to="/upload"><a className='btn btn-danger ml-5 mt-3'> <img src={require('./../assets/images/icons8-upload-to-cloud-50.png')}></img></a></Link></div>
                    ...
                    <button onClick={()=>navigate('/music')} className='btn btn-danger mt-5 ml-2'><div className='music '> <img src={require('./../assets/images/icons8-music-32.png')}></img>    Switch to Music Player</div></button>
                </div>
